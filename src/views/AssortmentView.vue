  ...
  <section id="discount" class="assortment">
    <div class="container assortment__container">
      ...
      <div class="assortment__button">
        <button class="btn btn__primary">ПЕРЕЙТИ К ДОСТАВКЕ</button>
      </div>
      <img class="assortment__tomato-img" src="../../public/img/assortiment/tomato.png" alt="tomato">
      <img class="assortment__basil1-img" src="../../public/img/assortiment/basil.png" alt="basil1">
      <img class="assortment__basil2-img" src="../../public/img/assortiment/basil2.png" alt="basil2">
    </div>
  </section>
</template>
<script setup>
